...
- [-] Strings collide with the floor, still pass through the puppet — see [strings-hit-floor.md](strings-hit-floor.md)
- [ ] Two players from one camera (handedness-correct, no string crossing) — see [two-player-handedness.md](two-player-handedness.md)
