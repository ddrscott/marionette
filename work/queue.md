...
- [ ] Extract a HandInputMethod class (finger→thumb pinch detection) — replace the keyboard's fist-select with any-finger pinch, add 0.01 damping to the UI cursor; reusable primitive for future game special moves — see [hand-input-method-pinch.md](hand-input-method-pinch.md)
