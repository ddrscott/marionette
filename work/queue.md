...
- [-] Add numbers, symbols & spacebar to the hand keyboard — mobile-style ?123/ABC layer toggle (letters ⇄ curated symbols), wide spacebar on both layers, physical-keyboard parity — see [keyboard-numbers-symbols.md](keyboard-numbers-symbols.md)
